...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("anchorMin", "anchorMax", "anchoredPosition", "sizeDelta", "pivot", "anchoredPosition3D", "offsetMin", "offsetMax", "drivenByObject", "drivenProperties", "position", "localPosition", "eulerAngles", "localEulerAngles", "right", "up", "forward", "rotation", "localRotation", "localScale", "parent", "parentInternal", "hasChanged", "hierarchyCapacity", "name")]
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "offsetMax":
						...
						break;
					case "drivenByObject":
					reader.SetPrivateProperty("drivenByObject", reader.Read<UnityEngine.Object>(), instance);
					break;
					case "drivenProperties":
					reader.SetPrivateProperty("drivenProperties", reader.Read<UnityEngine.DrivenTransformProperties>(), instance);
					break;
					case "position":
